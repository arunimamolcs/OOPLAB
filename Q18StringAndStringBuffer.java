...
import java.io.*;
class Q18StringAndStringBuffer
 {
	public static void main(String[] args)
	{
	StringBuffer s = new StringBuffer("Arunima");
		int p = s.length();
		int q = s.capacity();
		System.out.println("Length of string Arunima=" + p);
		System.out.println("Capacity of string Arunima=" + q);
    s.append(" molcs");
